...
describe('github api for profile details', () => {
    it('should get correct profile data', async () => {
        ...
        const profileDetails = await getProfileDetails('KayanShah', 'token');
    ...
    it('should throw error when api failed', async () => {
        ...
        await expect(getProfileDetails('KayanShah', 'token')).rejects.toThrow('GitHub api failed');
    });
});
